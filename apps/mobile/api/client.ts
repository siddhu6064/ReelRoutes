...
/**
 * Stream a chat reply token-by-token using fetch + ReadableStream.
 * React Native 0.74 (Expo 51) supports ReadableStream natively.
...
export function usePlanStatus(userId?: string | null) {
  return useQuery({
