...
3. Have this YouTube URL ready to paste:
   ...
   _(use a real Alaska travel video with good CC — e.g. Kara and Nate, Lost LeBlancs)_
...
_[Open chat panel, type "Build me a 7-day Alaska itinerary"]_
_[Reply appears with structured day-by-day plan]_
...
_[Click Share → share link copied]_
_[Open /share/:token in new tab — read-only map loads instantly]_

> "One click to share. Your friends see the full map — no login required.
> And at the bottom—"

_[Camera on the growth CTA banner]_

> "—they can import their own video. That's how we grow."

### 1:11–1:30 — Traction + Close

_[Switch to screen showing stats / product metrics]_
